...
const ITEMS: RoadmapItem[] = [
  ...
  },
  {
    ...
    title: '詞彙稽核（去工程化全站文案）',
    description:
      'SPOF→無備援主管、斷鏈→懸空匯報、層級深度→組織層級、節點→人員、邊→匯報線、捕捉快照→設定比較基準、function→跨部門職能、發布→改名留待 Phase 1 決定。',
    status: 'planned',
  ...
  },
  {
    ...
    title: '「保留事項」摘要',
    description:
      'scenarioCompare 結果加一欄「未變動的部分」（從 diff 反推），給員工 anchor。',
    status: 'planned',
    sources: ['cm'],
    size: 'small',
    phaseId: 'phase-0',
  },
  {
    ...
    description:
      '從現有 findings 自動算 100 分量表（Leadership / Capacity / Stakeholder / Infrastructure / Comms 五大類），在 /health 加分頁。',
    status: 'planned',
    sources: ['cm'],
    size: 'medium',
    phaseId: 'phase-0',
