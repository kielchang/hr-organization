...
- [x] `R5.2` **編輯態 before/after 浮層**：不發布也能看指標變化（✅ 完成 commit `8d72028`；4 指標即時 before→after、avgSpan 1 位小數精度自洽）
- [x] `R5.3` **CSV 欄位中文化**（✅ 完成 commit `086e4b3`；中文為主、英文向後相容，匯入/匯出/範本/錯誤訊息同步）
